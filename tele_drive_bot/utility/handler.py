...
from tele_drive_bot import OWNER, colab_bot
from natsort import natsorted
from datetime import datetime
from os import makedirs, path as ospath
from tele_drive_bot.uploader.telegram import upload_file
...
from tele_drive_bot.utility.converters import (
    archive,
    extract,
    videoConverter,
    sizeChecker,
...
async def SendLogs(is_leech: bool):
    ...
    l_ink = "⌬─────[「 Colab Usage 」](https://colab.research.google.com/drive/1eLyX84DTbmFyhv-ZbSpRYowkzwXhbx2x)─────⌬"
